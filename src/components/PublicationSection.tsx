...
const PublicationSection = () => (
  <section id="publication" className="section-padding relative bg-background">
    <div className="container mx-auto max-w-[1200px] relative z-10">
      <AnimatedSection>
        <p className="section-label">Research</p>
        <h2 className="text-3xl md:text-4xl font-bold mb-3 text-foreground tracking-tight">Published Work</h2>
        <p className="text-muted-foreground text-sm mb-12 max-w-md">Peer-reviewed research pushing the boundaries of healthcare AI.</p>
      </AnimatedSection>
        ...
        <div className="rounded-xl p-8 bg-card border border-border shadow-sm hover:shadow-lg hover:border-primary/30 transition-all duration-300 relative overflow-hidden">
          ...
          <div className="flex items-start gap-6 flex-col sm:flex-row">
            ...
            <div className="flex-1">
              ...
              <h3 className="text-xl font-bold mb-2 text-foreground leading-snug">
                Liver Disease Prediction using Deep Learning: TabNet vs XGBoost
              </h3>
              <p className="text-sm font-medium mb-1 text-primary">March 2025</p>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {tags.map((tag) => (
                  <span key={tag} className="text-xs px-3 py-1.5 rounded-md bg-muted text-muted-foreground font-medium">
                    {tag}
                  </span>
                ))}
              </div>
