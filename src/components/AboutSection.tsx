      ...
      <div className="grid lg:grid-cols-5 gap-12 items-start mt-10">
        <AnimatedSection delay={0.1} className="lg:col-span-3">
          <div className="space-y-5 text-muted-foreground text-[15px] leading-[1.8]">
            <p>
              I'm <span className="text-foreground font-semibold">Saktheeswar</span>, a fresh B.Tech graduate from
            ...
            <p>
              I specialize in <span className="text-primary font-medium">data analysis</span>, <span className="text-primary font-medium">time-series forecasting</span>, <span className="text-primary font-medium">computer vision</span>, and <span className="text-primary font-medium">deep learning</span>.
        ...
        <div className="lg:col-span-2 grid grid-cols-2 gap-4">
          {stats.map((s, i) => (
            <AnimatedSection key={s.label} delay={0.2 + i * 0.1}>
              <div className="rounded-xl p-5 bg-card border border-border shadow-sm hover:shadow-md hover:-translate-y-1 hover:border-primary/30 transition-all duration-300 text-center">
