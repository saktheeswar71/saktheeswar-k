    ...
    <div>
        ...
        {allActions.map((action, i) => {
          ...
          return (
            <motion.button
              ...
              style={{
                background: isSelected ? "#DAEBE3" : "#FFFFFF",
                border: isSelected ? "2px solid #99CDD8" : "1px solid #CFD6C4",
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4">
          <span className="text-sm" style={{ color: selectedActions.length > 0 ? "#99CDD8" : "#8a9e8f" }}>
